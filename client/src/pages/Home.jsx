        ...
        <div className="bg-brand-light min-h-screen">
            ...
            <div id="services" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Our Core Services</h2>
                    <p className="mt-4 text-lg text-gray-600">Compassionate In-Home Care tailored to your needs</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { title: 'Home Nursing', desc: 'Professional medical care at home including medication management and wound care.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-brand-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg> },
                        { title: 'Physiotherapy', desc: 'Restoring mobility and strength with personalized rehabilitation plans.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-brand-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> },
                        { title: 'Elderly Companion', desc: 'Daily assistance, social engagement, and support for independent living.', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-brand-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg> }
                    ].map((service, idx) => (
                        <div key={idx} className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-lg transition border border-green-50 flex flex-col items-center text-center">
                            <div className="bg-brand-light p-4 rounded-full mb-6 text-brand-dark">
                                {service.icon}
                            </div>
            ...
            {/* Technology Section */}
            <div id="technology" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white rounded-t-[50px]">
